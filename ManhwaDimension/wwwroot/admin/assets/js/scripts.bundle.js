...
var KTImageInput = function (element, options) {
    ...
    var _remove = function (e) {
        ...
        // Kích hoạt sự kiện 'remove'
        if (KTEventHandler.trigger(the.element, 'kt.imageinput.remove', the) === false) {
            return;
        }

        // Xóa class hiển thị trạng thái đã thay đổi
        the.element.classList.remove('image-input-changed');
        // Bỏ dòng thêm class 'image-input-empty' để giữ nút xoá luôn hiển thị
        // the.element.classList.add('image-input-empty');
        ...
        // Nếu có phần tử ẩn, đánh dấu đã xoá
        if (the.hiddenElement) {
            the.hiddenElement.value = '1';
        }

        // Nếu có thẻ <img> bên trong, đặt lại src về ảnh mặc định
        var imgElement = the.element.querySelector('img');
        if (imgElement) {
            imgElement.src = '/assets/media/images/blog/NoImage.png';
        }

        // Kích hoạt sự kiện 'removed'
        ...
        previewButton.addEventListener("click", function (e) {
            ...
            setTimeout(function () {
                if (mode == "light-sidebar") {
                    ...
                    $("#kt_app_sidebar_logo .app-sidebar-logo-default").attr("src", "/images/genestory/logos/Logo.png");
                } else {
