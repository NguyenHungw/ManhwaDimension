                    ...
                    if (t.multiple) {//multiple file
                        ...
                        if (tagName == "input") {
                            ...
                            t.dataSource.cache.forEach(function (item, i) {
                                html += `<div class="image-input image-input-outline image-input-placeholder mb-7"><div class="w-150px h-150px" id="divImage${i}"><img id="postPhoto${i}" src="${item.path}" file-path="${item.path}" class="w-150px h-150px shadow-image" file-accept="image/*"></div>
