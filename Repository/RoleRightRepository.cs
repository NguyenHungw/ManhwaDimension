...
//    {
//        public RoleRightRepository(BookwormDbContext _db) : base(_db)
//        {
//        }

//        public async Task<DTResult<RoleRightViewModel>> ListServerSide(RoleRightDTParameters parameters)
//        {
...
//            //3.Query second
//            var query2 = query.Select(c => new RoleRight()
//            {
//                Id = c.row.Id,
//                Code = c.row.Code,
//                Name = c.row.Name,
...
//            });
//            //4. Sort
//            query2 = query2.OrderByDynamic<RoleRight>(orderCritirea, orderDirectionASC ? LinqExtensions.Order.Asc : LinqExtensions.Order.Desc);
//            recordFiltered = await query2.CountAsync();
//            //5. Return data
//            return new DTResult<RoleRight>()
//            {
