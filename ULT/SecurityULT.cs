...
//            if (listRights != null)
//            {
//                RightId = (int)listRights.Where(x => x.Code.ToLower().Trim() == requestedURL.ToLower().Trim()).Select(x => x.Id).FirstOrDefault();
//            }
//            return RightId;
//        }
...
//            int MenuId = GetMenuIdFromRequestedURL(requestedURL, newListMenu);
//            if (MenuId == 0 && RoleId != SystemConstant.ROLE_SYSTEM_ADMIN)
//            {
//                //Không cần quyền --> Cho phép truy cập
//                return false;
//            }
