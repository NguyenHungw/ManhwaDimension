    ...
    dataTableLanguage: {
        "vi": {
            ...
            oPaginate: {
                sFirst: "Đầu tiên",
                sLast: "Cuối cùng",
                sNext: `<svg xmlns="http://www.w3.org/2000/svg" width="5" height="10" viewBox="0 0 5 10" fill="none">
  <path d="M0.75 0.75L2.21914 2.20609C3.39075 3.36729 3.97656 3.9479 4.06676 4.65556C4.08886 4.82894 4.08886 5.00439 4.06676 5.17778C3.97656 5.88544 3.39075 6.46604 2.21914 7.62724L0.749999 9.08333" stroke="black" stroke-width="1.5" stroke-linecap="round"/>
</svg>`,
                sPrevious: `<svg xmlns='http://www.w3.org/2000/svg' width='5' height='10' viewBox='0 0 5 10' fill='none'>
  <path d='M4.08333 9.08333L2.61419 7.62724C1.44258 6.46604 0.856775 5.88544 0.766575 5.17778C0.744475 5.00439 0.744475 4.82894 0.766575 4.65556C0.856775 3.9479 1.44258 3.36729 2.61419 2.20609L4.08333 0.75' stroke='black' stroke-width='1.5' stroke-linecap='round'/></svg>`
            },
